                        ...
                        <tbody>
                            @foreach($courses as $course)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            if($course->department_id == 1) echo 'Computer Science';
                                            elseif($course->department_id == 2) echo 'Mathematics';
                                            elseif($course->department_id == 3) echo 'English';
                                            elseif($course->department_id == 4) echo 'Physics';
