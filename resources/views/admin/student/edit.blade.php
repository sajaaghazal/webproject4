...
<div class="container mt-5 shadow-sm p-4 border rounded bg-white">
    <h2 class="mb-4">Edit Student: {{ $student->name }}</h2>
    ...
    <form action="{{ route('student.update', $student->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="stNo" id="stNo" class="form-control @error('stNo') is-invalid @enderror" 
        ...
        <div class="mb-3">
            ...
            <input type="number" name="avg" id="avg" step="0.01" class="form-control @error('avg') is-invalid @enderror" 
